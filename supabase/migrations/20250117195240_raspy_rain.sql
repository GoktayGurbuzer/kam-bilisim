...
SET 
  content = '<div class="product-content">
    ...
    <section class="mb-8">
      ...
      <ul class="list-disc pl-6 mt-4">
        ...
        <li>Dual fan system</li>
        <li>Optimized heat dissipation</li>
      </ul>
    </section>

    <section class="mb-8">
      <h2 class="text-2xl font-bold mb-4">Premium Audio</h2>
      <p>Immerse yourself in high-quality audio with Smart Amp Technology and Dolby Atmos support. The AI noise-canceling technology ensures clear communication during gaming or video calls.</p>
    </section>
  </div>',
  schema_markup = jsonb_build_object(
    'specifications', jsonb_build_object(
      ...
      'Special Features', '360-degree hinge, Touch screen support, ROG XG Mobile compatibility, AI noise-canceling technology'
    )
  )
